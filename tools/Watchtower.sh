...
configure_watchtower_settings() {
    ...
    read -p "是否为 Watchtower 配置标签筛选？(y/n) (例如：要更新带有 'com.centurylinklabs.watchtower.enable=true' 标签的容器，请输入 'com.centurylinklabs.watchtower.enable=true') (当前: ${WATCHTOWER_LABELS:-无}): " label_choice
...
echo "5) 📊 刷新并查看当前自动化更新状态" # 选项5现在变为“刷新并查看”
echo "6) 📝 查看/编辑脚本配置"
echo "7) 🔄 重新加载脚本 (当脚本自身更新时使用)"
echo -e "${COLOR_GREEN}===========================================${COLOR_RESET}"
read -p "请输入选择 [1-7]: " MODE
