#!/bin/bash
# =============================================================
# 🚀 Docker 自动更新助手 (v4.3.2 - Final UI & Command Fix)
# =============================================================
...
_get_visual_width() {
    ...
    width=$(( (multi_byte - arrow_count) * 2 + single_byte + arrow_count ))
    echo $width
}
# =============================================================
...
# =============================================================
# START: Restored all missing functions
# =============================================================
