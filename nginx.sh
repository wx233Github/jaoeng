# =============================================================
# 🚀 Nginx 反向代理 + HTTPS 证书管理助手 (v2.3.1-子菜单流程修复)
# =============================================================
# - 修复: (关键) 修正了所有子菜单（项目管理、账户管理）的回车逻辑。现在按回车会正确返回到 Nginx 模块的主菜单，而不是直接退出到父脚本。
# - 更新: (UI) 根据要求，将主菜单中的“管理 acme.sh 账户”选项的 emoji 从 '👤' 更改为 '🔑'。
