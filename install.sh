#!/bin/bash
# =============================================================
# 🚀 VPS 一键安装入口脚本 (v62.6 - Brace-Free Vars / Final Attempt)
# =============================================================
...
main() {
    ...
    load_config
    log_info "脚本启动 (v62.6 - Brace-Free Vars)"
